...
@section('main-content')
    ...
    <section class="row col-12">
        ...
        <div class="modal fade p-5" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-xl">
                <div class="modal-content p-3">
                        ...
                        <div class="edit-details-container col-12 row my-5">
                            ...
                            <form action="{{ route('users.update', $user->id) }}" method="POST"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" name="updatebtn" class="btn btn-primary">Update
                                        Details</button>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" name="updatebtn" class="btn btn-primary">Update Details</button>
                    </div>
                </div>
            </div>
        </div>
